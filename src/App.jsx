...
//       {/* ─── Intelligence Card (slides from right) ─── */}
...
//                   />
//                   <span
//                     className="text-[10px] font-semibold text-white/25 tracking-[0.25em] uppercase"
//                     style={{ fontFamily: "'JetBrains Mono', monospace" }}
//                   >
...
//                 {/* Description */}
//                 <motion.p
//                   className="text-[13px] leading-relaxed text-white/45 mb-7"
//                   initial={{ opacity: 0 }}
//                   animate={{ opacity: 1 }}
...
//                 >
//                   <span
//                     className="text-[9px] font-semibold text-white/15 tracking-[0.25em] uppercase block mb-3"
//                     style={{ fontFamily: "'JetBrains Mono', monospace" }}
//                   >
//                     TECH STACK
//                   </span>
...
//                     whileTap={{ scale: 0.97 }}
//                     className="flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-[13px] font-semibold transition-all duration-200 border border-white/8 bg-white/5 hover:bg-white/10 text-white/60 hover:text-white"
//                   >
...
//                     whileHover={{ scale: 1.03, y: -1 }}
//                     whileTap={{ scale: 0.97 }}
//                     className="flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-[13px] font-bold transition-all duration-200 text-black"
//                     style={{
...
//                 >
//                   <span
//                     className="text-[9px] font-semibold text-white/15 tracking-[0.25em] uppercase block mb-4"
//                     style={{ fontFamily: "'JetBrains Mono', monospace" }}
//                   >
//                     ORBITAL TELEMETRY
//                   </span>
...
//                       <span
//                         className="text-[9px] text-white/20 tracking-widest uppercase block mb-1.5"
//                         style={{ fontFamily: "'JetBrains Mono', monospace" }}
//                       >
//                         VELOCITY
//                       </span>
...
//                           style={{ color: selectedProject.color, fontFamily: "'Orbitron', sans-serif" }}
//                         >
...
//                 {/* Signal indicator */}
//                 <motion.div
//                   className="flex items-center gap-2 mt-6 pt-4 border-t border-white/[0.03]"
//                   initial={{ opacity: 0 }}
//                   animate={{ opacity: 1 }}
...
//                   <span
//                     className="text-[9px] text-white/15 tracking-[0.2em] uppercase"
//                     style={{ fontFamily: "'JetBrains Mono', monospace" }}
//                   >
